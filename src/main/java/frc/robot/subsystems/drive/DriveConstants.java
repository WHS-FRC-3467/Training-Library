 ...
 * <ul>
 * <li>PID gains for drive and steer motors</li>
 * <li>Physical dimensions (wheel radius, gear ratios, module positions)</li>
...
public class DriveConstants {
    ...
    private static final Slot0Configs driveGains =
        new Slot0Configs().withKP(0.1).withKI(0).withKD(0).withKS(0)
            .withKV(0.124);
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(-0.384521484375);
